    ...
    <>
      <div className='h-2/4 w-10/12 flex flex-col justify-center gap-8 px-2 text-slate-600 shadow-lg'>
        <label className='flex flex-col text-2xl h-2/4 gap-[20%]' htmlFor='nombre_empresa'>Nombre de la empresa
          <input className='bg-transparent border-solid border-b-2 border-slate-300 text-slate-600 font-medium outline-none focus:border-slate-500' placeholder='Nombre' ref={nombre_empresa} />
        </label>
