  ...
  return (
    <div className='bg-slate-200 h-3/5 border-solid border-2 border-slate-400 rounded-lg w-10/12 flex flex-col justify-center gap-8 px-2 text-slate-600'>
      ...
      <div className="flex w-3/5 gap-4">
        ...
        <button onClick={() => handler('genero', generosMusicales.current.value)} className='px-4 bg-green-100 border-green-700 border-2 border-solid rounded-md text-green-700 h-8'>Guardar</button>
      </div>
    </div>
  );
};
