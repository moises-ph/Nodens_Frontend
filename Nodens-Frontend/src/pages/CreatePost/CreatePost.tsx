...
const CreatePost = () => {
    ...
    return (
        <>
            <main className='bg-[#003F5A] h-screen w-full'>
                ...
                <section>
                    <div className="pt-20 pl-4 absolute">
                        <Button onClick={handleShow} variant="priamry" className="bg-slate-100 w-48 h-9 rounded-xl">
                            Crear Publicación
                        </Button>
                    </div>
                    ...
                    <Modal show={show} onHide={handleClose} className="">
                        ...
                        <Modal.Body>¿En que estás pensando?</Modal.Body>
                        <Modal.Footer>
