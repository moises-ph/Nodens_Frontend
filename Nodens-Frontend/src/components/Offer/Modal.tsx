...
const Modal = ({open, oferta, setOpen}:{open:boolean, oferta: OffersT | undefined, setOpen: React.Dispatch<React.SetStateAction<boolean>>}) => {
...
const change=(e: any)=>{
  ...
  return (
	...
	>
		<Offer oferta={oferta} setOpen={setOpen}/>
