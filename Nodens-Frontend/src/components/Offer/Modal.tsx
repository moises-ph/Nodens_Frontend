...
const Modal = ({open, oferta}:{open:boolean, oferta: OffersT | undefined}) => {
  return (
	<motion.div
		...
		variants={variants}
		className='h-[90vh] overflow-y-scroll fixed w-full bg-slate-100 rounded-lg  shadow-slate-300 shadow-inner rounded-t-xl'
		exit={{translateY: '100vh'}}
	>
		<Offer oferta={oferta}/>
			<div className='flex justify-center items-center pt-28 w-full pr-16'>
