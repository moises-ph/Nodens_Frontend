...
function SingleOffer(props : any) {
  return (
      <div onClick={()=>props.showModal(props.offer)} key={parseInt(props.Key)} className="w-full h-44 flex flex-col p-4 border-2 border-solid border-slate-300 gap-1 rounded-lg hover:bg-slate-100 hover:cursor-pointer">
