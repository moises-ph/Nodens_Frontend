...
const NavOrganizerRes = ({profImg} : {profImg : string}) => {
  ...
  return (
    <nav className="hidden md:flex fixed bg-slate-900 items-center justify-around h-[7vh] lg:gap-4 gap-[1%] w-full z-50">
      ...
      <Link to="/" className="flex items-center translate-x-[25rem]"><IndexLink /><h3 className="text-slate-50 font-semibold">NODENS</h3></Link>
      <div className="w-full flex justify-evenly items-center lg:justify-end gap-[2%] pr-20 translate-x-[-20rem]">
