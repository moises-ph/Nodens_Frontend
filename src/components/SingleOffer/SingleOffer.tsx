...
function SingleOffer(props : any) {
  ...
  return (
    <div className={`${props.id && props.id === props.offer._id ? 'bg-blue-200' : ''} group w-full min-h-fit flex flex-col px-3 pt-4 pb-2 border-b border-b-solid border-slate-300 gap-1 transition-colors rounded-b-none hover:cursor-pointer ${props.isHomePage ? "backdrop-blur-md shadow-md" : null}`}>
