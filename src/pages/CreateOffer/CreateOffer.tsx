...
const CreateOffer = () => {
  ...
  return (
    <>
      <main className="w-full h-fit flex flex-col items-center justify-center gap-2 pt-6 bg-slate-200">
        ...
        <form className="w-full md:w-4/6 lg:w-3/6 flex flex-col items-center bg-transparent gap-4 pb-6 z-30" onSubmit={(e)=> e.preventDefault()}>
          ...
          <label className="w-5/6 h-1/6 bg-zinc-900 rounded-xl p-3 flex flex-col gap-6">
            ...
            <span onClick={(e)=>{e.preventDefault(); addRequeriment();}} className="text-slate-100">Agregar Requerimiento</span>
          </label>
          <label className="w-5/6 h-1/6 bg-zinc-900 rounded-xl p-3 flex flex-col gap-6">
            ...
            <span onClick={(e)=>{e.preventDefault() ; addTag()}} className="text-slate-100">Agregar Tag</span>
          </label>
