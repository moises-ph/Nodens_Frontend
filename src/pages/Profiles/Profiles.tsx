...
const Profile = () => {
  ...
  return (
    <>
      <main className="h-screen overflow-y-hidden bg-slate-200 "> 
        <div className="pt-8 md:p-8 pb-3 h-fit w-full flex flex-col  md:flex-row ls gap-4 border-b-[1px] z-10 bg-slate-200 border-solid border-slate-500">
