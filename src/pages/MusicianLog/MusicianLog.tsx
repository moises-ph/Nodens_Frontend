...
const MusicianLog = () => {
  ...
  return (
    <>
      <main className="h-screen flex flex-col w-full items-center py-4 bg-gradient-to-br bg-[#003F5A]">
      ...
      <button onClick={()=>{localStorage.removeItem("authTokenForTheUser"); location.reload()}}>salir</button>
        ...
        <h1 className="mb-8 text-3xl font-semibold text-slate-100">Registro de Musico</h1>
